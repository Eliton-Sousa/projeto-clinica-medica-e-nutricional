...
A aplicação apresenta os principais serviços oferecidos, equipe profissional e formas de contato, sendo ideal como modelo de sistema inicial ou protótipo para clínicas.
...
* Exibição da equipe profissional
...
```bash
# Clone o repositório
git clone https://github.com/eliton-sousa/projeto-clinica-medica-e-nutricional.git

# Acesse a pasta
cd projeto-clinica-medica-e-nutricional
